  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-4xl mx-auto p-6 space-y-8">
        ...
        {/* ── How I Work (project-specific) ── */}
        <div>
          <h2 className="text-lg font-semibold mb-4">How I&apos;d Build This</h2>
        ...
        >
          ...
          <h2 className="text-xl font-light text-white/60">
            Let&apos;s bring{" "}
            <span className="font-bold text-white">MyAirportMap</span>{" "}
            to the App Store
          </h2>
          <p className="text-sm text-white/50 leading-relaxed max-w-lg">
            I can have a TestFlight build ready within the first week. The demo above shows the UX I&apos;d build for the subscription flow and native shell.
          </p>
